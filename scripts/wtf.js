...
function thenewcallout(){
  ...
  function baller(){
    alert("You dont belong in here, you have to be a paying customer/ patreon to proceed!");
  }
  ...
  function alwaysDown(){
    alert("Sorry, something went wrong please try again. If the error persists try again later!");
  }
